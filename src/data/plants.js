...
export const plantsData = [
    ...
    { id: 2, name: 'Fiddle Leaf Fig', category: 'interior', categoryName: 'Plantas de Interior', price: 65.99, image: 'https://images.unsplash.com/photo-1586093017032-576d3dc7e1cf?w=400&h=400&fit=crop&crop=center', description: 'Elegante planta de interior con hojas grandes en forma de violín que añade un toque moderno a cualquier espacio.', care: 'Luz brillante indirecta, riego moderado, ambiente estable' },
    ...
    { id: 6, name: 'Aloe Vera', category: 'suculentas', categoryName: 'Suculentas', price: 28.99, image: 'https://images.unsplash.com/photo-1624230300401-b24b6a55ab08?w=400&h=400&fit=crop&crop=center', description: 'Planta medicinal con propiedades curativas, perfecta para el hogar y fácil de cuidar.', care: 'Luz solar directa, riego mínimo, suelo bien drenado' },
    { id: 7, name: 'Lavanda', category: 'aromaticas', categoryName: 'Plantas Aromáticas', price: 22.99, image: 'https://images.unsplash.com/photo-1587845910073-4ed2a0e5fb21?w=400&h=400&fit=crop&crop=center', description: 'Fragante planta aromática con flores púrpuras, ideal para relajación y uso culinario.', care: 'Pleno sol, suelo bien drenado, riego moderado' },
    { id: 8, name: 'Rosemary', category: 'aromaticas', categoryName: 'Plantas Aromáticas', price: 19.99, image: 'https://images.unsplash.com/photo-1617359736704-ccedece2cdfc?w=400&h=400&fit=crop&crop=center', description: 'Hierba aromática perenne con hojas en forma de aguja, perfecta para cocinar.', care: 'Sol pleno, suelo seco y bien drenado, riego escaso' },
